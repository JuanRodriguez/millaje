...
Function php_Main ()
{
	...
	{
		case $clsSite_Site: $szURL .= "Site/view.php"; break;
		case $clsSite_Apps: $szURL .= "Apps/view.php"; break;
		case $clsSite_App: $szURL .= "App/view.php"; break;
		case $clsSite_Help: $szURL .= "Help/view.php"; break;
		case $clsSite_Policies: $szURL .= "Policies/view.php"; break;
		case $clsSite_Policy: $szURL .= "Policy/view.php"; break;
		case $clsSecurity_Security: $szURL .= "Security/view.php"; break;
		case $clsSecurity_Groups: $szURL .= "Groups/view.php"; break;
		case $clsSecurity_Group: $szURL .= "Group/view.php"; break;
		case $clsSecurity_UserRef: $szURL .= "UserRef/view.php"; break;
		case $clsSecurity_Users: $szURL .= "Users/view.php"; break;
		case $clsSecurity_User: $szURL .= "User/view.php"; break;
		case $clsSecurity_Login: $szURL .= "Login/view.php"; break;
		case $clsCommon_Notes: $szURL .= "Notes/view.php"; break;
		case $clsCommon_Note: $szURL .= "Note/view.php"; break;
	}
	...
	// header ("Location:" . dirPath() . "Marketing/Security/helloworld.php");
}
?>