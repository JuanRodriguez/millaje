...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Security/User.gif", "cmdAdd_User");
...
<?
	...
	// Import CSS
?>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Users/trgrs_PathList.js.php?szNameSpace=<?= $pnlPath->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Users/trgrs_HButtonBar.js.php?szNameSpace=<?= $pnlButtons->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Users/trgrs_FolderDetail.js.php?szNameSpace=<?= $pnlList->getPanelName() ?>&"></script>
<?
}
?>