...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/folder_new.gif", "cmdAdd_PolicyFolder");
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/file_new.gif", "cmdAdd_Policy");
	...
	// Conditional delete - can only delete policy folders inside policy folders.
	// Groups, Users and Site are not allowed to be deleted.
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/empty.gif", "");
...
<script src="<?= pagePath () ?>Marketing/Security/Admin/Policies/trgrs_FolderDetail.js.php?szNameSpace=<?= $pnlList->getPanelName() ?>&"></script>
