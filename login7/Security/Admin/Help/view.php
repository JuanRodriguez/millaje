...
<?
	...
	// Import CSS
?>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Help/trgrs_PathList.js.php?szNameSpace=<?= $pnlPath->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Help/trgrs_HButtonBar.js.php?szNameSpace=<?= $pnlButtons->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Help/trgrs_FolderDetail.js.php?szNameSpace=<?= $pnlList->getPanelName() ?>&"></script>
<?
}
?>