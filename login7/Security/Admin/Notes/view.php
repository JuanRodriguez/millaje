...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/folder_new.gif", "cmdAdd_NoteFolder");
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/file_new.gif", "cmdAdd_Note");
...
<?
	...
	// Import CSS
?>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Notes/trgrs_PathList.js.php?szNameSpace=<?= $pnlPath->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Notes/trgrs_HButtonBar.js.php?szNameSpace=<?= $pnlButtons->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Notes/trgrs_FolderDetail.js.php?szNameSpace=<?= $pnlList->getPanelName() ?>&"></script>
<?
}
?>