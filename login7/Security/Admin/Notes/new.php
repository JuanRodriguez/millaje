...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/folder_closed.gif", "cmdAdd_NoteFolder");
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/file.gif", "cmdAdd_Note");
...
<script src="<?= pagePath () ?>Marketing/Security/Admin/Notes/trgrs_FormData.js.php?szNameSpace=<?= $szNameSpace ?>&"></script>
<?
}
?>