...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Security/User.gif", "cmdAdd_UserRef");
	...
	// only allow deletion of groups other than Everything and Administors
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/empty.gif", "");
...
<script src="<?= pagePath () ?>Marketing/Security/Admin/Group/trgrs_FolderDetail.js.php?szNameSpace=<?= $pnlList->getPanelName() ?>&"></script>
