...
Function php_Main ()
{
	...
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/folder_closed.gif", "cmdAdd_UserRefFolder");
	$pnlButtons->addButton (pagePath() .  "Images/Ladder/file.gif", "cmdAdd_UserRef");
...
<?
	...
	// Import JavaScript
?>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Group/trgrs_PathList.js.php?szNameSpace=<?= $pnlPath->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/Group/trgrs_HButtonBar.js.php?szNameSpace=<?= $pnlButtons->getPanelName() ?>&"></script>
<script src="<?= pagePath () ?>Marketing/Security/Admin/group/trgrs_FormData.js.php?szNameSpace=<?= $szNameSpace ?>&"></script>
