...
<?= $szNameSpace ?> =
{
	cmdAdd_PolicyFolder : function ()
	{
		szParams =
			"nID=" + <?= $szParent ?>.nCurrentID + "&" +
			"szNameSpace=" + <?= $szParent ?>.szNameSpace + "&" ;

		<?= $szApp ?>.getPanel ("policies/new.php", <?= $szParent ?>.divTarget, szParams);
		<?= $szApp ?>.selected (<?= $szParent ?>.nCurrentID);
	},

	cmdAdd_Policy : function ()
	{
		szParams =
			"nID=" + <?= $szParent ?>.nCurrentID + "&" +
			"szNameSpace=" + <?= $szParent ?>.szNameSpace + "&" ;

		<?= $szApp ?>.getPanel ("policy/new.php", <?= $szParent ?>.divTarget, szParams);
		<?= $szApp ?>.selected (<?= $szParent ?>.nCurrentID);
	},
	...
	cmdDelete : function ()
	{
		...
		<?= $szApp ?>.getPanel ("policies/deletebummer.php", <?= $szParent ?>.divTarget, szParams);
		<?= $szApp ?>.selected (<?= $szParent ?>.nCurrentID);
	},
