...
****************/
mysql_connect('localhost', 'millaje', 'signeng') or trigger_error("Unable to connect to the database: " . mysql_error());
mysql_select_db('millaje') or trigger_error("Unable to switch to the database: " . mysql_error());
